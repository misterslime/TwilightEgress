...
namespace Cascade.Content.Projectiles.Ranged
{
    ...
    public class ChickenCannonItemOverrides : GlobalItem
    {
        public override bool InstancePerEntity => true;

        public override bool AppliesToEntity(Item entity, bool lateInstantiation) => entity.type == ModContent.ItemType<ChickenCannon>();
